...
import { MonitorKpiProd } from "../interfaces/menu/monitorInterface";
...
let insertModalData: MonitorKpiProd; // 등록할 변수
...
let editModalData: MonitorKpiProd; // 수정할 변수
...
<template>
  ...
  >
    <Dialog.Panel class="p-10 text-center">
      <!--추가 Modal 내용 시작-->
      <div class="mb-5" style="font-weight: bold">KPI 시간당 생산량 등록</div>
